...
<html lang="en">
  <head>
    ...
    <title>Hello DevOps Students of RMIT Vietnam!!! Mark as failed build</title>
  </head>
  <body>
    ...
    <div class="jumbotron">
      ...
      <p class="lead">This website is build automatically by Jenkins!!! Yeahhhh!!! New Test for Poll SCM!</p>
      <hr class="my-4">
